            ...
            <table id="content-table">
                ...
                <?php foreach($customers as $customer): ?>
                    <tr>
                        ...
                        <td><a href="/manager/customers/customer-update.php?id=<?= $customer['id'] ?>">Update</a></td>
                        <td><a href="/manager/customers/customer-delete-process.php?id=<?= $customer['id'] ?>">Delete</a></td>
                    </tr>
                <?php endforeach ?>
            </table>
            </div>

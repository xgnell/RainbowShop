...
<body>
    ...
    <div class="page-body">
        ...
        <div class="page-content">
            <!-- Item insertion form -->
            <form action="/manager/items/item_insert_process.php" method="POST" enctype="multipart/form-data">
                ...
                Choose color: <select name="color" id="display-color">
                    ...
                    <?php
                        ...
                        foreach ($item_colors as $item_color) {
                            ?>
                            <option value="<?= $item_color['color'] ?>"><?= $item_color['color'] ?></option>
                            <?php
                        }
                    ?>
                </select><br>
                ...
                <table id="display-size">
                    ...
                    <tr>
                        ...
                        <?php
                            foreach ($item_sizes as $item_size) {
                                ?>
                                <td><input name="size-<?= $item_size["size"] ?>" type="number"></td>
                                <?php
                            }
                        ?>
                    </tr>

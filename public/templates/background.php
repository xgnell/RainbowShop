    ...
    <div class="content_bar">
        <div class="content">
            <div class="search_bar_in_background">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" height="60" viewBox="0 0 24 24" width="40">
                ...
                <span style="float: left;">
                    <input type="text" placeholder="Nhấn Enter để tìm kiếm">
                </span>
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="60" viewBox="0 0 24 24" width="40">

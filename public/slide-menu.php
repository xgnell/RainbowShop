...
<img class="slide-menu-arrow" onclick="click_arrow()" src="public/img/arrow_forward_ios-24px.svg" width="30" height="30">
<script defer>
    function open_menu() {
        document.querySelector("#nav-slide-menu").style.marginLeft = "0px";
        document.querySelector(".slide-menu-arrow").style.marginLeft = "255px";
        document.querySelector(".slide-menu-arrow").src = "public/img/arrow_back_ios-24px.svg";
    }

    function close_menu() {
        document.querySelector("#nav-slide-menu").style.marginLeft = "-250px";
        document.querySelector(".slide-menu-arrow").style.marginLeft = "0px";
        document.querySelector(".slide-menu-arrow").src = "public/img/arrow_forward_ios-24px.svg";
    }
